...
const testimonials = [
  { name: 'Mridul Gehlot', rating: 5, review: "It's was worth it.", profilePhoto: '/placeholder-avatar.svg' },
  { name: 'Tejas Rajguru', rating: 4, review: 'Good session overall.', profilePhoto: '/placeholder-avatar.svg' },
  { name: 'Ritesh Beuria', rating: 4, review: 'It was very insightful, fast-paced and long.', profilePhoto: '/placeholder-avatar.svg' },
  { name: 'Sneha Kurcheeti', rating: 5, review: 'Great session!', profilePhoto: '/placeholder-avatar.svg' },
  ...
  { name: 'Aryan Singh', rating: 4, review: "Great session. I wouldn't say I'm a business master now, but it has really set up a base of context and curiosity for finance. Thanks!", profilePhoto: '/placeholder-avatar.svg' },
  { name: 'Viraj Joshi', rating: 5, review: 'It was literally great. Topics like P/E ratio that I had heard before are now crystal clear.', profilePhoto: '/placeholder-avatar.svg' },
  ...
  { name: 'Amogh Sridhar', rating: 4, review: 'The content was nice but felt a little basic. I understand it had to cater to a larger audience. Also, you could improve your speaking and presentation skills - no offense.', profilePhoto: '/Testmonials/Photo - Amogh.jpeg' },
  { name: 'Prajwal', rating: 5, review: 'The session explained Balance Sheets, P&L, Cash Flow, investing, stocks, and VC in a simple and practical way. It was engaging and provided a strong foundation for finance and entrepreneurship.', profilePhoto: '/Testmonials/Prajwal Revanna.png' },
  ...
  { name: 'Geetha', rating: 5, review: "With no finance background, this session was extremely helpful. I've followed you since your IIM days and it was a pleasure to attend. Looking forward to future sessions.", profilePhoto: '/placeholder-avatar.svg' },
  ...
  { name: 'Moksh Kumar', rating: 5, review: "Best cohort I've done. Learned a lot in a short span. Kaafi cool session!", profilePhoto: '/placeholder-avatar.svg' },
  { name: 'Devesh Gupta', rating: 5, review: 'Great session. Biggest takeaways were balance sheet analysis and VC pitching. I now feel more confident analyzing companies.', profilePhoto: '/placeholder-avatar.svg' },
  { name: 'Harsh Mishra', rating: 5, review: 'Excellent content and delivery. Coming from a non-finance background, I understood almost everything in one go.', profilePhoto: '/placeholder-avatar.svg' },
  { name: 'Thanushree N', rating: 5, review: 'Very informative. Starting with real numbers was a great approach. Loved it!', profilePhoto: '/placeholder-avatar.svg' },
